...
const Header = () => {
  ...
  <Image
    ...
    width={119.03}
    height={30}
    className="w-full lg-dark:hidden"
  />
</a>
        ...
        {/* Nav Menu Start   */}
        <div
          className={`invisible h-0 w-full items-center justify-around xl:visible xl:flex xl:h-auto xl:w-full ${navigationOpen &&
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col gap-6 xl:flex-row xl:items-center xl:gap-6 xl:ml-0 mt-7 xl:mt-0">
              <ThemeToggler />
              <Link
              ...
              <Link
                href="https://nextjstemplates.com/templates/solid"
                className="flex items-center justify-center rounded-full bg-white px-7.5 py-2.5 text-regular text-primary duration-300 ease-in-out hover:bg-primaryho"
              >
                SIGN IN
              </Link>
            </div>
