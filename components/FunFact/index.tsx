      ...
      <section className="px-4 py-20 md:px-8 lg:py-22.5 2xl:px-0">
        <div className="relative z-1 mx-auto max-w-c-1390 rounded-lg bg-gradient-to-t from-[#F8F9FF] to-[#DEE7FF] py-22.5 dark:bg-blacksection dark:bg-gradient-to-t dark:from-transparent dark:to-transparent dark:stroke-strokedark xl:py-27.5">
          <Image
            width={450}
            height={350}
            src="/images/shape/shape-4.png"
            alt="Man"
            className="absolute -z-1 lg:left-0 hidden sm:block"
          />
          <Image
            width={180}
            height={180}
            ...
            alt="Doodle"
            className="absolute bottom-0 right-8 -z-1 hidden sm:block"
          />
          ...
          >
            ...
            PENS - UA dirancang dengan tampilan responsif yang memastikan pengalaman pengguna optimal sehingga dapat digunakan di berbagai perangkat, baik di desktop, tablet, maupun smartphone.
            </p>
          </motion.div>
