        ...
        <div className="mx-auto max-w-c-1390 rounded-lg bg-gradient-to-t from-[#F8F9FF] to-[#DEE7FF] px-7.5 py-12.5 dark:bg-blacksection dark:bg-gradient-to-t dark:from-transparent dark:to-transparent dark:stroke-strokedark md:px-12.5 xl:px-17.5 xl:py-0">
          <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center md:justify-between md:gap-0">
            ...
            >
              ...
              Mulai & Dapatkan Kemudahan dalam Layanan Kesehatan
              </h2>
              <p>
              Dengan sistem kami yang terintegrasi, Anda bisa mengakses riwayat medis, hasil pemeriksaan, dan layanan kesehatan lainnya secara cepat dan aman. Nikmati pengalaman layanan kesehatan digital yang memprioritaskan kenyamanan dan privasi Anda kapan pun, di mana pun.
              </p>
            </motion.div>
            <motion.div
              variants={{
